                                ...
                                <div className="py-12">
                                    <div className="max-w-lg lg:max-w-md mx-auto lg:mx-0 mb-8 text-center lg:text-left">
                                        <h2 className="text-3xl lg:text-5xl mb-4 font-bold font-heading wow animate__animatedanimated animate__fadeIn">
                                           Vi brenner for <span className="text-blue-500">brukeropplevelser</span>
                                        </h2>
                                        <p className="text-blueGray-400 leading-relaxed wow animate__animated animate__fadeIn">
                                            Vi er <strong className="text-blue-500">MEDIATRAFIKK</strong>{" "}

                                        </p>
                                        <p className="text-blueGray-400 leading-relaxed wow animate__animatedanimated animate__fadeIn mt-3 text-sm">Vi gjør det enkelt og trygt for deg å samarbeide med influencere. </p>
                                    </div>
                                    <div className="text-center lg:text-left">
                                        <Link href="/#plan2">
                                            <a className="tracking-wide hover-up-2 block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-blue-400 hover:bg-blue-500 rounded wow animate__animatedanimated animate__fadeIn">Priser</a>
                                        </Link>
                        ...
                        <div className="flex flex-wrap items-center justify-between max-w-2xl lg:max-w-full mb-12">
                            ...
                            <div className="w-full lg:w-1/2">
                                <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn">Vi
                                    kontakter deg etter bestilling og hjelper deg gjennom hele prosessen. Vi fikser
                                    bilder / video til annonsen, samt kommunikasjon og oppfølging med influenceren. </p>
                            </div>
                        </div>
                        <div className="flex flex-wrap -mx-3 -mb-6 text-center">
                            ...
                            <div
                                ...
                                <div className="p-12 bg-white shadow rounded">
                                    ...
                                    <p className="text-sm text-blueGray-400 leading-relaxed">Vi planlegger tidspunkt for
                                        annonsering og andre detaljer rundt annonseringen. </p>
                                </div>
                            </div>
                            <div className="hover-up-5 w-full lg:w-1/3 px-3 mb-6">
                                <div className="p-12 bg-white shadow rounded wow animate__animated animate__fadeIn"
                                    ...
                                    <p className="text-sm text-blueGray-400 leading-relaxed">Vi sørger for at
                                        annonseringen gjennomføres i henhold til dine forventninger.</p>
                                </div>
                            </div>
                        </div>
                    </div>
