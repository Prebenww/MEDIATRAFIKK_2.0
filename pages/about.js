                            ...
                            <div className="w-full lg:w-1/2 px-3">
                                <div className="py-12">
                                    <div className="max-w-lg lg:max-w-md mx-auto lg:mx-0 mb-8 text-center lg:text-left">
                                        ...
                                        <p className="text-blueGray-400 leading-relaxed wow animate__animatedanimated animate__fadeIn mt-3 text-sm">Fremtiden for UX-testing - rett foran øynene dine. Vår visjon er å lede ann en revolusjon innen brukertesting med heatmaps.</p>
                                    </div>
                ...
                <section className="py-20 bg-blue-500">
                    <div className="container">
                        <div className="text-center max-w-xl mx-auto">
                            ...
                            <p className="mb-8 text-blueGray-200">Send oss en E-post, så tar vi kontakt med deg for
                                videre informasjon.</p>
