        ...
        <>
            <Layout>
                <section className="relative -mt-24 pt-24">
                    <div className="flex lg:block absolute inset-0 w-1/2 ml-auto bg-blueGray-100 z-0" style={{ "z-index": "-1" }}></div>
                        ...
                        <div className="flex flex-wrap items-center -mx-3">
                            ...
                            <div className="w-full lg:w-1/2 px-3 lg:bg-blueGray-10 mb-12 lg:mb-0 pb-10">
                                <div className="flex items-center justify-center">
                                    <div  className="jump rounded wow animate__animated animate__fadeIn  " >
                                        <video autoPlay muted loop className='h-128 w-80   '>
