...
/*        <div className="relative max-w-6xl mt-16 md:mt-8  overflow-hidden  ">
            <img src="/assets/imgs/elements/pattern.png" className='mb-24 ' alt="Monst" />
                    ...
                    <div className="container">
                        <div className="flex flex-wrap items-center -mx-3">
                            <div className="w-full lg:w-2/5 px-3">
                                <div className="max-w- lg:max-w-md mx-auto lg:mx-0 mb-8 text-center lg:text-left">
                            ...
                            <div className="w-full lg:w-3/5 px-3 mb-12 lg:mb-0">
                                <div className="lg:h-128 flex items-center justify-center">
                                    <video autoPlay muted loop className='jump rounded wow animate__animated animate__fadeIn  h-128 w-full   '>
                                        <source src="/WEB-TARGET.webm" type="video/mp4"/>
                                    </video>                                </div>
                            </div>
                        </div>
                    </div>
